 ...
 * @Package: xyz.bugcoder.leetcode_pp.array
 * @author: Weiyj
 * @Description: 设计一个支持增量操作的栈
 * @createTime 2020-11-03 09:37
 */
public class CustomStack_Mid_1381 {

    // 存放数据
    private int[] data;
    // data的指针，控制显示data的内容，pop并不是真的删除元素
    private int n;
    public CustomStack_Mid_1381(int maxSize) {
    ...
    public static void main(String[] args) {
        CustomStack_Mid_1381 stack = new CustomStack_Mid_1381(5);
        stack.push(1);
        stack.push(2);
        stack.push(3);
        stack.push(4);
