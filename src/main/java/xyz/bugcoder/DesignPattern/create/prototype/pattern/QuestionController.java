...
import xyz.bugcoder.DesignPattern.create.prototype.normal.AnswerQuestion;
import xyz.bugcoder.DesignPattern.create.prototype.normal.ChoiceQuestion;
...
// 优点：
//  便于通过克隆⽅式创建复杂对象、也可以避免重复做初始化操作、 不需要与类中所属的其他类耦合等
// 缺点:
//  如果对象中包括了循环引⽤的克隆，以及类中 深度使⽤对象的克隆，都会使此模式变得异常麻烦。
