...
public class TBNetMall extends NetMall {
    ...
    public TBNetMall(String uId, String pwd) {
        super(uId, pwd);
    }

    @Override
    protected boolean login(String uId, String pwd) {
        logger.info("模拟TaoBao⽤户登录 uId：{} uPwd：{}", uId, pwd);
        return true;
    }
    ...
    protected Map<String, String> reptile(String url) {
        ...
        map.put("price", "4999.00");
        logger.info("模拟TaoBao商品爬⾍解析：{} | {} 元 {}", map.get("name"), map.get("price"), url);
        return map;
    }
    ...
    protected String createBase64(Map<String, String> goodsInfo) {
        ...
        logger.info("模拟⽣成TaoBao商品base64海报");
